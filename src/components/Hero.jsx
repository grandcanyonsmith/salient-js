  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        {textContent.headline_part_1 || 'Loading...'}{' '}
        <span className="relative whitespace-nowrap text-red-600">
          ...
          <span className="relative">{textContent.headline_part_2_words_in_red || 'Loading...'}</span>
        </span>{' '}
        {textContent.headline_part_3 || 'Loading...'}
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        {textContent.subheadline || 'Loading...'}
      </p>
      <div className="mt-10 flex justify-center gap-x-6">
        <Button href="/register">{textContent.offer || 'Loading...'}</Button>
        <Button
        ...
        >
          ...
          <span className="ml-3">{textContent.cta || 'Loading...'}</span>
        </Button>
      </div>
      <div className="mt-36 lg:mt-44">
        <p className="font-display text-base text-slate-900">
          {textContent.trust_statement || 'Loading...'}
        </p>
        <ul
          role="list"
