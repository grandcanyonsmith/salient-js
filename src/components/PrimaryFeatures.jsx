...
export function PrimaryFeatures() {
  ...
  const features = [
    {
      title: textContent.feature_1_title || 'Loading...',
      description: textContent.feature_1_description || 'Loading...',
      image: screenshotPayroll,
    },
    {
      title: textContent.feature_2_title || 'Loading...',
      description: textContent.feature_2_description || 'Loading...',
      image: screenshotExpenses,
    },
    {
      title: textContent.feature_3_title || 'Loading...',
      description: textContent.feature_3_description || 'Loading...',
      image: screenshotVatReturns,
    },
    {
      title: textContent.feature_4_title || 'Loading...',
      description: textContent.feature_4_description || 'Loading...',
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl">
            {textContent.feature_headline || 'Loading...'}
          </h2>
          <p className="mt-6 text-lg tracking-tight text-red-100">
            {textContent.feature_subheadline || 'Loading...'}
          </p>
        </div>
        <TabGroup
